...
int testPictureCoordianteTrans()
{
	...
	Shader ourShader("resource/textures1Coord.vs", "resource/textures2.frag");
	...
	//glVertexAttribPointer(2, 2, GL_FLOAT, 3 * sizeof(float), 8, (void*)(6 * sizeof(float)));
	//glBindTexture()
	while (!glfwWindowShouldClose(window))
	{
		...
		//will affect. The number of texture units an implementation supports 
		//is implementation dependent, but must be at least 80.
...
int testPictureCoordiante36face()
{
	...
	Shader ourShader("resource/textures1CoordOnlyWenli.vs", "resource/textures2.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (GLuint i = 0; i < 10; i++)
		{
			...
			if (i % 3 == 0)  // every 3rd iteration (including the first) we set the angle using GLFW's time function.
				angle =static_cast<GLfloat>( glfwGetTime()) * 25.0f;
...
static void key_callback_camera(GLFWwindow* window, int key, int scancode, int action, int mode);
